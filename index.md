...
Another approach has been transfer learning. TimeNet [[25](#25)] is created specifically to serve as a pretrained and publicly available time-series specific deep learning network for common use. There is also the transfer learning from image models mentioned above.
...
## References
1. <a id="1"></a>[UEA & UCR Time Series Classification Repository.](http://timeseriesclassification.com) *timeseriesclassification.com*.
1. <a id="2"></a>Schäfer, P. (2015) [The BOSS is concerned with time series classification in the presence of noise.](https://www2.informatik.hu-berlin.de/~schaefpa/boss.pdf) *Data Min Knowl Discov 29, 1505–1530*.
1. <a id="3"></a>Wang Z. et al. (2017) [Time Series Classification from Scratch with Deep Neural Networks: A Strong Baseline.](https://arxiv.org/pdf/1611.06455v4.pdf) *IJCNN 2017: 1578-1585*.
1. <a id="4"></a>Cover T.M., Hart P.E. (1967) [Nearest neighbor pattern classification](https://isl.stanford.edu/~cover/papers/transIT/0021cove.pdf) *IEEE Trans Inf Theory 13(1)21–27*.
1. <a id="5"></a>Müller M. (2007) [Dynamic Time Warping](https://link.springer.com/book/10.1007/978-3-540-74048-3) *In Information Retrieval for Music and Motion 69-84*
1. <a id="6"></a>Iwana B. K., Uchida S. (2020) [Time Series Data Augmentation for Neural Networks by Time Warping with a Discriminative Teacher.](https://arxiv.org/pdf/2004.08780v1.pdf) *arXiv:2004.08780v1*.
1. <a id="7"></a>Sultana F. et al (2018) [Advancements in Image Classification using Convolutional Neural Network](https://arxiv.org/pdf/1905.03288.pdf) *4th Int Conf Res Comput Intell Commun Netw (ICRCICN), Kolkata, India, 122-129*
1. <a id="8"></a>Krizhevsky A (2009) [Learning Multiple Layers of Features from Tiny Images](http://www.cs.toronto.edu/~kriz/learning-features-2009-TR.pdf).
1. <a id="9"></a>[Imagenet](http://www.image-net.org/). *www.image-net.org.*
1. <a id="10"></a>Wang Z., Oates T. (2015) [Imaging Time-Series to Improve Classification and Imputation](https://www.ijcai.org/Proceedings/15/Papers/553.pdf). *In: 24 Int Joint Conf Arti Intell*.
1. <a id="11"></a>Dau H.A. et al (2019) [The UCR Time Series Archive](https://arxiv.org/pdf/1810.07758) *IEEE/CAA J Autom Sinica, (6) 6, 1293-1305*
1. <a id="12"></a>Ye L., Keogh E. (2009) [Time series shapelets: a new primitive for data mining](http://alumni.cs.ucr.edu/~lexiangy/Shapelet/Shapelet.pdf). *In KDD ’09: Proc 15th ACM SIGKDD Int Conf Knowl Discov Data Min.*
1. <a id="13"></a>Bagnall, A. et al. (2016) [The great time series classification bake off: a review and experimental evaluation of recent algorithmic advances. Extended Version](https://arxiv.org/pdf/1602.01711.pdf). *arXiv:1602.01711*.
1. <a id="14"></a>Amidon A. (2020) [A Brief Survey of Time Series Classification Algorithms](https://medium.com/data-science/a-brief-introduction-to-time-series-classification-algorithms-7b4284d31b97) *Towardsdatascience.com*.
1. <a id="15"></a>Gupta A. et al (2020) [Approaches and Applications of Early Classification of Time Series: A Review](https://arxiv.org/pdf/2005.02595v2.pdf) *arXiv:2005.02595v2*.
1. <a id="16"></a>Bagnall A. et al. (2015) [Time-Series Classification with COTE: The Collective of Transformation-Based Ensembles](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7069254). *In IEEE Trans Knowl Data Eng., 27, (9) 2522-2535*.
1. <a id="17"></a>Lines J. et al. (2016) [HIVE-COTE: The Hierarchical Vote Collective of Transformation-Based Ensembles for Time Series Classification](https://core.ac.uk/download/pdf/77027925.pdf). *In IEEE 16th Int Conf Data Min (ICDM), 1041-1046*.
1. <a id="18"></a>Shifaz A. (2020) [TS-CHIEF: A Scalable and Accurate Forest Algorithm for Time Series Classification](https://arxiv.org/pdf/1906.10329.pdf). *Data Min Knowl Discov 34, 742-75*.
1. <a id="19"></a>Dempster A., Petitjean F, Webb G.I. (2020) [ROCKET: exceptionally fast and accurate time series classification using random convolutional kernels](https://arxiv.org/pdf/1910.13051.pdf). *Data Min Knowl Discov 34, 1454–1495*.
1. <a id="20"></a>Lin J.et al (2007) [Experiencing SAX: a novel symbolic representation of time series](https://cs.gmu.edu/~jessica/SAX_DAMI_preprint.pdf). *Data Min and Knowl Discov, 15(2):107–144*
1. <a id="21"></a>Lin J., R. Khade, and Y. Li. (2012) [Rotation-invariant similarity in time series using bag-of-patterns representation](https://cs.gmu.edu/~jessica/publications/BOP_jiis12.pdf). *J Intell Inf Sys, 39(2):287–315*
1. <a id="22"></a>Deng et al. (2013) [A time series forest for classification and feature extraction](https://arxiv.org/pdf/1302.2277.pdf). *Inf Sci 239, 142-153.*
1. <a id="23"></a>Kaggle [Intro to Deep Learning](https://www.kaggle.com/learn/intro-to-deep-learning).
1. <a id="24"></a>Fawaz H.I. et al (2019) [Deep learning for time series classification: a review](https://link.springer.com/content/pdf/10.1007/s10618-019-00619-1.pdf) *Data Min Knowl Disc 33, 917–963*
1. <a id="25"></a>Malhotra P. et al. (2017) [TimeNet: Pre-trained deep recurrent neural network for time series classification](https://www.researchgate.net/profile/Pankaj-Malhotra-2/publication/316940352_TimeNet_Pre-trained_deep_recurrent_neural_network_for_time_series_classification/links/594d682eaca27248ae3430a0/TimeNet-Pre-trained-deep-recurrent-neural-network-for-time-series-classification.pdf?_tp=eyJjb250ZXh0Ijp7ImZpcnN0UGFnZSI6InB1YmxpY2F0aW9uIiwicGFnZSI6InB1YmxpY2F0aW9uIn19) *In: ESANN 2017 proc, Eur Symp Artif Neural Netw Comput Intell Mach Learn Bruges (Belgium)*.
1. <a id="26"></a>Fawaz H.I. (2020) [InceptionTime: Finding AlexNet for time series classification](https://arxiv.org/pdf/1909.04939.pdf) *Data Min Knowl Discov 34 1936–62*
1. <a id="27"></a>Fawaz H.I. et al (2018) [Data augmentation using synthetic data for time series classification with deep residual networks](https://arxiv.org/pdf/1808.02455v1.pdf) *arXiv:1808.02455.*
1. <a id="28"></a>Iwana B. K., Uchida S. (2020) [An Empirical Survey of Data Augmentation for Time Series Classification with Neural Networks](https://arxiv.org/pdf/2007.15951.pdf). *arXiv:2007.15951v1*
1. <a id="29"></a>Regan M. (2018) [Github code repo: K-Nearest-Neighbors-with-Dynamic-Time-Warping](https://github.com/markdregan/K-Nearest-Neighbors-with-Dynamic-Time-Warping)
1. <a id="30"></a>[Papers with code – time series classification](https://paperswithcode.com/task/time-series-classification)
